                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@нік бренду</label><input type="text" id="solid-text-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                                <div class="cs-field">
                                    <label>Колір фону</label>
                                    <div style="display:flex;gap:8px;align-items:center;">
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@нік бренду</label><input type="text" id="photo-text-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@нік бренду</label><input type="text" id="social-proof-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@&#x43D;&#x456;&#x43A; &#x431;&#x440;&#x435;&#x43D;&#x434;&#x443;</label><input type="text" id="promo-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@нік бренду</label><input type="text" id="bullet-list-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                                <div class="cs-field">
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>@нік бренду</label><input type="text" id="bar-chart-brandHandle" value="@fineko.space" placeholder="@brand"></div>
                                <div class="cs-field">
