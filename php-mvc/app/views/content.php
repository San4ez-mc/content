                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field">
                                    ...
                                    <textarea rows="3" id="ai-bg-prompt" placeholder="cinematic dark office with holographic screens, dramatic blue lighting, 8k professional photography">cinematic dark office with holographic financial screens, dramatic blue lighting, 8K professional photography, vertical 9:16</textarea>
                                ...
                                <div class="cs-field"><label>Заголовок (опційно)</label><textarea rows="2" id="ai-bg-title" placeholder="За одне заняття — повна фінансова система">Фінансова система твого бізнесу</textarea></div>
                                <div class="cs-field"><label>Підзаголовок (опційно)</label><input type="text" id="ai-bg-subtitle" placeholder="Cashflow · P&amp;L · Баланс" value="Cashflow · P&L · Баланс"></div>
                                <div class="cs-field"><label>Мітка/тег (опційно)</label><input type="text" id="ai-bg-extra" placeholder="&#x1F4CC; ЛАЙФХАК · ТОП-3" value="📌 ЛАЙФХАК"></div>
                                <div class="cs-field">
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                ...
                                <div class="cs-field"><label>Пілюля-тег зверху (опційно)</label><input type="text" id="multi-plate-tag" placeholder="📌 ЛАЙФХАК · ТОП-3 · ВАЖЛИВО" value="📌 ЛАЙФХАК · ТОП-3"></div>
                                <div class="cs-field"><label>Головний текст (плашка)</label><textarea rows="3" id="multi-plate-title" placeholder="За одне заняття — повна фінансова система">За одне заняття — повна фінансова система</textarea></div>
                                <div class="cs-field">
                                ...
                                <div class="cs-field"><label>Підблок / пояснення (опційно)</label><input type="text" id="multi-plate-subtitle" placeholder="Cashflow · P&amp;L · Баланс" value="Cashflow · P&L · Баланс"></div>
                                <div class="cs-field"><label>CTA-плашка внизу (опційно)</label><input type="text" id="multi-plate-cta" placeholder="Пиши 2 у коментарях 👇" value="Пиши + у коментарях 👇"></div>
                                <div class="cs-field">
            ...
            <tr class="cs-inline-row" id="form-social-proof">
                <td colspan="5">
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field"><label>Повідомлення клієнта</label><textarea rows="3" id="social-proof-quote" placeholder="Нарешті зрозумів куди йдуть гроші! Вже перший місяць у плюс 😊">Нарешті зрозумів куди йдуть гроші! Вже перший місяць у плюс 😊 Дякуюза курс!</textarea></div>
                                <div class="cs-field"><label>Ім'я клієнта</label><input type="text" id="social-proof-author" value="Марія К." placeholder="Марія К."></div>
                                <div class="cs-field"><label>Твоя відповідь (опційно)</label><input type="text" id="social-proof-result" value="Так тримати! 💪" placeholder="Так тримати! Це тільки початок 💪"></div>
                                <div class="cs-field"><label>Дата (опційно)</label><input type="text" id="social-proof-date" value="Сьогодні" placeholder="Сьогодні / 12 травня / вчора"></div>
...
Баланс — активи і борги | Повна картина бізнесу</textarea>
            ...
            <!-- ══ КОЛАЖ / АНІМОВАНА ЦИТАТА ══ -->
            <tr class="cs-block-header" data-filter="story"><td colspan="5">🖼 Колаж та цитата</td></tr>

            <!-- Polaroid Collage -->
            <tr class="cs-data-row" data-filter="story" data-id="polaroid-collage">
                <td><div class="cs-type-cell"><div class="cs-icon cs-icon-img" style="background:#fdf6ec;border-color:#f5d9a8">🪄</div><div><div class="cs-type-name">Поляроїд-колаж</div><div class="cs-type-desc">2–3 фото у вигляді поляроїдів на пастельному фоні з анімацією влітання. Ідеально для "день у житті", кейсів, серій подій.</div><span class="cs-funnel-tag" style="background:#fef9ec;color:#92400e;border-color:#fde68a">⚡ HyperFrames</span></div></div></td>
                <td><span class="cs-badge cs-badge-img">Сторіз</span></td>
                <td style="font-size:13px;color:#374151;">9:16 · MP4</td>
                <td><span class="cs-status-ready"><span class="cs-status-dot dot-green"></span>Готово</span></td>
                <td><button class="cs-launch-btn" onclick="toggleForm('polaroid-collage')">▶ Запустити</button></td>
            </tr>
            <tr class="cs-inline-row" id="form-polaroid-collage">
                <td colspan="5">
                    <div class="cs-inline-panel">
                        <div class="cs-panel-header">
                            <span style="font-size:20px">🪄</span>
                            <span class="cs-panel-title">Поляроїд-колаж</span>
                            <button class="cs-close-btn" onclick="toggleForm('polaroid-collage')">✕</button>
                        </div>
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field"><label>Фото 1 (URL) *</label><input type="url" id="polaroid-collage-photo1Url" placeholder="https://...jpg"></div>
                                <div class="cs-field"><label>Підпис до фото 1</label><input type="text" id="polaroid-collage-caption1" placeholder="Ранок у студії..."></div>
                                <div class="cs-field"><label>Фото 2 (URL)</label><input type="url" id="polaroid-collage-photo2Url" placeholder="https://...jpg"></div>
                                <div class="cs-field"><label>Підпис до фото 2</label><input type="text" id="polaroid-collage-caption2" placeholder=""></div>
                                <div class="cs-field"><label>Фото 3 (URL)</label><input type="url" id="polaroid-collage-photo3Url" placeholder="https://...jpg (необов'язково)"></div>
                                <div class="cs-field"><label>Підпис до фото 3</label><input type="text" id="polaroid-collage-caption3" placeholder=""></div>
                                <div class="cs-field"><label>Текст внизу</label><input type="text" id="polaroid-collage-title" placeholder="Мій тиждень / Так виглядає результат"></div>
                                <div class="cs-field"><label>Бренд / акаунт</label><input type="text" id="polaroid-collage-brandHandle" placeholder="@fineko.ua"></div>
                                <div class="cs-field">
                                    <label>Колір акценту</label>
                                    <div style="display:flex;gap:8px;align-items:center;">
                                        <input type="color" id="polaroid-collage-accentColor" value="#6b4f2a" style="width:48px;height:36px;border:1px solid #d1d5db;border-radius:8px;padding:2px;cursor:pointer;" oninput="document.getElementById('polaroid-collage-accentColor-text').value=this.value">
                                        <input type="text" id="polaroid-collage-accentColor-text" value="#6b4f2a" style="flex:1;" oninput="syncColorText('polaroid-collage-accentColor','polaroid-collage-accentColor-text')">
                                    </div>
                                </div>
                                <div class="cs-field"><label>Колір фону</label>
                                    <select id="polaroid-collage-bgColor">
                                        <option value="#f5f0e8">Теплий беж (за замовч.)</option>
                                        <option value="#f0f4f8">Холодний сірий</option>
                                        <option value="#fef9ec">Вершковий</option>
                                        <option value="#f0fdf4">М'ятний</option>
                                        <option value="#1a1a2e">Темний</option>
                                    </select>
                                </div>
                                <div class="cs-field"><label>Якість</label>
                                    <select id="polaroid-collage-quality">
                                        <option value="draft">Чернетка (~30 сек)</option>
                                        <option value="standard" selected>Стандарт (~1-2 хв)</option>
                                        <option value="high">Висока (~3-5 хв)</option>
                                    </select>
                                </div>
                                <button class="cs-gen-btn" id="btn-polaroid-collage" onclick="generateViaHF('polaroid-collage','polaroid-collage')">▶ Згенерувати</button>
                                <div class="cs-error-box" id="err-polaroid-collage"></div>
                            </div>
                            <div class="cs-panel-preview"><div id="preview-polaroid-collage"><div class="cs-preview-placeholder"><span>🪄</span><span>Результат тут</span></div></div></div>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <!-- Animated Quote -->
            <tr class="cs-data-row" data-filter="story" data-id="animated-quote">
                <td><div class="cs-type-cell"><div class="cs-icon cs-icon-img" style="background:#fff7ed;border-color:#fed7aa">💬</div><div><div class="cs-type-name">Анімована цитата</div><div class="cs-type-desc">Ключова думка або цитата з'являється рядок за рядком поверх фото-фону. Частини між *зірочками* підсвічуються кольором акценту.</div><span class="cs-funnel-tag" style="background:#fef9ec;color:#92400e;border-color:#fde68a">⚡ HyperFrames</span></div></div></td>
                <td><span class="cs-badge cs-badge-img">Сторіз</span></td>
                <td style="font-size:13px;color:#374151;">9:16 · MP4</td>
                <td><span class="cs-status-ready"><span class="cs-status-dot dot-green"></span>Готово</span></td>
                <td><button class="cs-launch-btn" onclick="toggleForm('animated-quote')">▶ Запустити</button></td>
            </tr>
            <tr class="cs-inline-row" id="form-animated-quote">
                <td colspan="5">
                    <div class="cs-inline-panel">
                        <div class="cs-panel-header">
                            <span style="font-size:20px">💬</span>
                            <span class="cs-panel-title">Анімована цитата</span>
                            <button class="cs-close-btn" onclick="toggleForm('animated-quote')">✕</button>
                        </div>
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field"><label>Фото-фон (URL)</label><input type="url" id="animated-quote-photoUrl" placeholder="https://...jpg (залиш порожнім для темного фону)"></div>
                                <div class="cs-field">
                                    <label>Текст цитати *</label>
                                    <textarea rows="3" id="animated-quote-quote" placeholder="Правильний контент *відкриває будь-які двері*&#10;Обгорніть акцентні слова у *зірочки*"></textarea>
                                    <div class="cs-field-hint">Слова між *зірочками* підсвічуються кольором акценту</div>
                                </div>
                                <div class="cs-field"><label>Автор / підпис</label><input type="text" id="animated-quote-author" placeholder="— Олександр Мацук"></div>
                                <div class="cs-field"><label>Бренд / акаунт</label><input type="text" id="animated-quote-brandHandle" placeholder="@fineko.ua"></div>
                                <div class="cs-field">
                                    <label>Колір акценту</label>
                                    <div style="display:flex;gap:8px;align-items:center;">
                                        <input type="color" id="animated-quote-accentColor" value="#f59e0b" style="width:48px;height:36px;border:1px solid #d1d5db;border-radius:8px;padding:2px;cursor:pointer;" oninput="document.getElementById('animated-quote-accentColor-text').value=this.value">
                                        <input type="text" id="animated-quote-accentColor-text" value="#f59e0b" style="flex:1;" oninput="syncColorText('animated-quote-accentColor','animated-quote-accentColor-text')">
                                    </div>
                                </div>
                                <div class="cs-field"><label>Якість</label>
                                    <select id="animated-quote-quality">
                                        <option value="draft">Чернетка (~30 сек)</option>
                                        <option value="standard" selected>Стандарт (~1-2 хв)</option>
                                        <option value="high">Висока (~3-5 хв)</option>
                                    </select>
                                </div>
                                <button class="cs-gen-btn" id="btn-animated-quote" onclick="generateViaHF('animated-quote','animated-quote')">▶ Згенерувати</button>
                                <div class="cs-error-box" id="err-animated-quote"></div>
                            </div>
                            <div class="cs-panel-preview"><div id="preview-animated-quote"><div class="cs-preview-placeholder"><span>💬</span><span>Результат тут</span></div></div></div>
                        </div>
                    </div>
                </td>
            </tr>
...
Прибуток | 67000 | #00d4ff</textarea>
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field">
                                    ...
                                    <input type="url" id="video-subs-videoUrl" placeholder="https://...mp4" value="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4">
                    ...
                    <div class="cs-inline-panel">
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field">
                                    <label>URL відео</label>
                                    <input type="url" id="video-karaoke-videoUrl" placeholder="https://...mp4" value="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4">
            ...
            <!-- B-roll AI -->
            <tr class="cs-block-header" data-filter="video"><td colspan="5">🎬 AI B-roll (текст → відео)</td></tr>
            <tr class="cs-data-row" data-filter="video" data-id="broll-kling">
                <td><div class="cs-type-cell"><div class="cs-icon cs-icon-reel" style="background:#f0f9ff">🎬</div><div><div class="cs-type-name">AI B-roll відео (Kling 1.6 Pro)</div><div class="cs-type-desc">Текстовий промпт → Kling 1.6 Pro (fal.ai) → вертикальне відео 9:16 для Reels/TikTok. 5 або 10 сек. ~$0.49–$0.98.</div><span class="cs-funnel-tag">&#128279; content-video-broll</span></div></div></td>
                        ...
                        <div class="cs-panel-inner">
                            <div class="cs-panel-form">
                                <div class="cs-field">
                                    ...
                                    <textarea rows="4" id="broll-kling-prompt" placeholder="cinematic slow motion shot of coins falling on dark surface, dramatic gold lighting, macro photography, 4K ultra realistic">cinematic slow motion coins falling on dark marble surface, dramatic gold and blue lighting, shallow depth of field, 4K ultra realistic</textarea>
                                ...
                                <div class="cs-field" style="margin-bottom:6px">
                                    ...
                                    <div style="display:flex;flex-wrap:wrap;gap:6px">
                                        <button type="button" class="cs-pick-gallery-btn" style="font-size:12px" onclick="document.getElementById('broll-kling-prompt').value='cinematic slow motion coins falling on dark marble surface, dramatic gold and blue lighting, shallow depth of field, 4K'">💰 Монети</button>
                                        <button type="button" class="cs-pick-gallery-btn" style="font-size:12px" onclick="document.getElementById('broll-kling-prompt').value='dynamic financial charts rising upward with glowing neon lines, dark background, cinematic motion, blue and gold palette'">📈 Графіки</button>
                                        <button type="button" class="cs-pick-gallery-btn" style="font-size:12px" onclick="document.getElementById('broll-kling-prompt').value='aerial city night timelapse, glowing skyscraper lights, car trails, cinematic vertical shot, ultra realistic 4K'">🌆 Місто</button>
                                        <button type="button" class="cs-pick-gallery-btn" style="font-size:12px" onclick="document.getElementById('broll-kling-prompt').value='hands typing on laptop in dark office, holographic financial data floating around, blue ambient light, cinematic'">💻 Офіс</button>
                                        <button type="button" class="cs-pick-gallery-btn" style="font-size:12px" onclick="document.getElementById('broll-kling-prompt').value='abstract dark fluid background with golden particles flowing upward, luxury aesthetic, 4K smooth motion'">✨ Абстракт</button>
                                    </div>
                                </div>
                                <div class="cs-field">
                                ...
                                <button class="cs-gen-btn" id="btn-broll-kling" onclick="generateBroll('broll-kling')">🎬 Згенерувати відео</button>
    ...
    <div style="font-size:12px;color:#9ca3af;text-align:center;padding-bottom:24px;margin-top:4px;">
        <strong style="color:#22c55e">14 готових</strong> (AI Фон + Силует×2 + Мультиплашки + Карусель×2 + Solid/Photo/SocProof/Promo + Karaoke + AI B-roll + Поляроїд + Цитата) ·
...
function buildHFData(template, prefix) {
    ...
    if (template === 'polaroid-collage') {
        return {
            photo1Url:   document.getElementById(prefix + '-photo1Url')?.value?.trim() || '',
            photo2Url:   document.getElementById(prefix + '-photo2Url')?.value?.trim() || '',
            photo3Url:   document.getElementById(prefix + '-photo3Url')?.value?.trim() || '',
            caption1:    document.getElementById(prefix + '-caption1')?.value || '',
            caption2:    document.getElementById(prefix + '-caption2')?.value || '',
            caption3:    document.getElementById(prefix + '-caption3')?.value || '',
            title:       document.getElementById(prefix + '-title')?.value || '',
            brandHandle: document.getElementById(prefix + '-brandHandle')?.value || '',
            accentColor: document.getElementById(prefix + '-accentColor')?.value || '#6b4f2a',
            bgColor:     document.getElementById(prefix + '-bgColor')?.value || '#f5f0e8',
        };
    }
    if (template === 'animated-quote') {
        return {
            photoUrl:    document.getElementById(prefix + '-photoUrl')?.value?.trim() || '',
            quote:       document.getElementById(prefix + '-quote')?.value || '',
            author:      document.getElementById(prefix + '-author')?.value || '',
            brandHandle: document.getElementById(prefix + '-brandHandle')?.value || '',
            accentColor: document.getElementById(prefix + '-accentColor')?.value || '#f59e0b',
        };
    }
    return {};
}
...
async function generateBroll(prefix) {
    ...
    errBox.style.display = 'none';
    previewDiv.innerHTML = '<div class="cs-preview-placeholder"><span>🎬</span><span>Генеруємо відео...</span></div>'
        + '<div class="cs-progress"><div class="cs-progress-bar"></div></div>'
    ...
    try {
        ...
        showError(prefix, e.message); btn.disabled = false; btn.innerHTML = '🎬 Згенерувати відео'; return;
    }
    btn.innerHTML = '<div class="spinner"></div> Генеруємо...';
    const result = await pollStatus(jobId, prefix);
    btn.disabled = false; btn.innerHTML = '🎬 Згенерувати відео';
    if (!result) return;
    if (result.mediaType === 'video' && result.videoUrl) {
        previewDiv.innerHTML = '<div class="cs-video-box"><video src="' + result.videoUrl + '" controls loop playsinline autoplay muted></video></div>'
            ...
            + '<button class="cs-action-btn" onclick="copyUrl(\'' + result.videoUrl + '\',this)">🔗 URL</button>'
            + '</div>'
